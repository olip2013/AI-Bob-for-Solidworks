...
public class ClaudeClient
{
    ...
    {
        // Non-interpolated raw string — no escaping needed for { } in code examples.
        // Date is substituted via Replace to avoid interpolation conflicts.
        return """
        ...
        model.SketchManager.CreateCornerRectangle(0, 0, 0, 0.05, 0.03, 0);
        ...
        ## Tone
        Be concise and friendly. Confirm ambiguous intent before scripting.
        After a successful script, summarise what was created in one sentence.

        Current date: DATE_PLACEHOLDER
        """.Replace("DATE_PLACEHOLDER", DateTime.Now.ToString("yyyy-MM-dd"));
    }
    ...
    private static string LoadApiKey()
    {
        ...
        var env = System.Environment.GetEnvironmentVariable("ANTHROPIC_API_KEY");
